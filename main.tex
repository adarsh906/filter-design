...
\author{Adarsh A\\EE23BTECH11203}
\date{}
...
\begin{align}
    \omega_{s1} &= 2\pi\frac{F_{s1}}{F_s} = 0.154 \pi\\
     \omega_{s2} &= 2\pi\frac{F_{s2}}{F_s} = 0.23 \pi\\
\end{align}
\end{enumerate}
...
$\Omega_{p1} = 0.2735$, $\Omega_{p2} = 0.3600$ and $\Omega_{s1} = 0.2467$, $\Omega_{s2} = 0.3778$
respectively.
...
\end{equation}
where $\Omega_0 = \sqrt{\Omega_{p1}\Omega_{p2}} = 0.314$ and $B = \Omega_{p2} - \Omega_{p1} = 0.0865$.

Substituting $\Omega_{s1}$ and $\Omega_{s2}$ in \eqref{eq:freq_transform} we obtain the stopband edges of lowpass filter 
\begin{align}
    \Omega_{Ls1} &= \frac{\Omega_{s1}^2 - \Omega_0^2}{B\Omega_{s1}} = -1.768\\
    \Omega_{Ls2} &= \frac{\Omega_{s2}^2 - \Omega_0^2}{B\Omega_{s2}} = 1.351
\end{align}
And we choose the minimum of these two stopband edges
\begin{align}
    \Omega_{Ls} = \mbox{min}(\vert \Omega_{Ls_1}\vert,\vert \Omega_{Ls_2}\vert) = 1.351
\end{align}
...
\begin{lstlisting}
https://github.com/adarsh906/filter-design/blob/main/codes/plot1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/adarsh906/filter-design/blob/main/codes/sk_gen.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/adarsh906/filter-design/blob/main/codes/pole_zero_plt.py
\end{lstlisting}
\begin{figure}[H]
\centering
